...
#define AI_GRUNET_DATA_ACTIVATIONS_SIZE     (2800)

#define AI_GRUNET_DATA_WEIGHTS_SIZE         (134104)

#define AI_GRUNET_DATA_ACTIVATIONS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8, \
    1, 1, AI_GRUNET_DATA_ACTIVATIONS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )

#define AI_GRUNET_DATA_WEIGHTS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8|AI_BUFFER_FMT_FLAG_CONST, \
    1, 1, AI_GRUNET_DATA_WEIGHTS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )
