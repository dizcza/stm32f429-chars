 ...
 * @ref ai_grunet_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_GRUNET_*
 * defines into file @ref grunet.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
